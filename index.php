...
<body>
    ...
    <div class="bg-white">
        ...
        <div class="px-60 flex flex-wrap -mb-4 justify-between">
            <?php foreach ($cards as $card):
            ?>
            <a href="jatekszin.hu">
                <div class="max-w-56 rounded overflow-hidden shadow-lg mb-4 card">
                    ...
                    <div class="px-6 pt-4 pb-2">
                        ...
                        ?>
                            <span class="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-green-700 mr-2 mb-2"><?= $card['rarity']?></span>
                        <?php elseif($card["rarity"] == "Common"):
                        ?>
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2"><?= $card['rarity']?></span>
                        <?php endif; ?>
